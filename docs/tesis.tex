...
\toprule
\endhead
\includegraphics[width=\textwidth,height=1\textheight]{input/images/INTERACCION2.png} \\
\bottomrule
\end{longtable}
...
{\centering \includegraphics[width=0.9\linewidth]{input/images/PLOTINT2} 
...
\toprule
\endhead
\includegraphics[width=\textwidth,height=1\textheight]{input/images/INTERACCION3.png} \\
\bottomrule
\end{longtable}
...
\toprule
\endhead
\includegraphics[width=\textwidth,height=1\textheight]{input/images/INTERACCION4.png} \\
\bottomrule
\end{longtable}
