...
knitr::kable(data.frame(image='![](input/images/INTERACCION1.png){height=80%}'),    # generar tabla
...
```{r, echo=FALSE, results='asis', fig.align = 'center'}
knitr::kable(data.frame(image='![](input/images/INTERACCION2.png){height=80%}'),    # generar tabla
...
```{r, echo=FALSE, results='asis', fig.align = 'center'}
knitr::kable(data.frame(image='![](input/images/INTERACCION3.png){height=80%}'),    # generar tabla
...
```{r, echo=FALSE, results='asis', fig.align = 'center'}
knitr::kable(data.frame(image='![](input/images/INTERACCION4.png){height=80%}'),    # generar tabla
